...
import { Github, Linkedin, Mail, ExternalLink, Code2, Database, NotebookPen, BarChart, Wrench, GripVertical } from 'lucide-react';
import AnimatedSeparator from './components/AnimatedSeparator';
import ChatInterface from './components/ChatInterface'; // Added import for ChatInterface
    ...
    <div className="min-h-screen p-8 md:p-16">
      ...
      >
        ...
        <div className="flex gap-4 mb-6">
          <a href="https://xristos-katsaros.medium.com/" className="text-text hover:text-blue-400"><NotebookPen size={24} /></a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="card">
            ...
            <div className="flex flex-col gap-4">
              {/* <img 
                src="public\va-screen.png" 
                alt="Vibe Atlas" 
                className="rounded-lg object-fit w-full h-auto"
              /> */}
          ...
          <div className="card">
            ...
            <div className="flex flex-col gap-4">
              {/* <img 
                src="public\1_ubE7BXWQmWXCyn4yzlhvLw.webp" 
                alt="Policing In The Pandemic" 
                className="rounded-lg object-scale-down w-full h-auto"
              /> */}
          ...
          <div className="card">
            ...
            <div className="flex flex-col gap-4">
              {/* <img 
                src="public\1_ubE7BXWQmWXCyn4yzlhvLw.webp" 
                alt="Bots and Trolls" 
                className="rounded-lg object-scale-down w-40 h-auto"
              /> */}
          ...
          <div className="card">
            ...
            <div className="flex flex-col gap-4">
              {/* <img 
                src="public\1_ubE7BXWQmWXCyn4yzlhvLw.webp" 
                alt="Democratic Primary Analysis" 
                className="rounded-lg object-scale-down w-40 h-auto"
              /> */}
          ...
          <div className="card">
            ...
            <div className="flex flex-col gap-4">
              {/* <img 
                src="public\1_ubE7BXWQmWXCyn4yzlhvLw.webp" 
                alt="Stable Audio Sample Generator" 
                className="rounded-lg object-scale-down w-40 h-auto"
              /> */}
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="max-w-lg">
            <h3 className="text-xl font-semibold mb-4">Play a game before you leave</h3>
            <ChatInterface />
          </div>
        </div>
      </section>
